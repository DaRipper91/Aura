...
# Use 'EOF' to prevent host variable expansion
...
# 6.5 FISH SHELL OPTIMIZATION
echo "🐟 Optimizing Fish Shell..."
...
# 9.1 TAILSCALE AUTH (Deferred to first run if key is missing)
# Note: Key-based auth is handled in the host block if provided
